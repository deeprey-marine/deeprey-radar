...
// controls.
//
// Macro:   Either HAVE_CONTROL (if it has this) or SKIP_CONTROL (if it doesn't
// have it) Field 1: Control identifier Field 2: 0 = No auto, n = maximum auto
// value
...
// Note that due to how the C++ preprocessor works, { } must be defined in a
// nested define
...
HAVE_CONTROL(CT_ANTENNA_STARBOARD, CTD_AUTO_NO, CTD_DEF_ZERO, -100, +100,
    CTD_STEP_1, CTD_NUMERIC)
HAVE_CONTROL(CT_MAIN_BANG_SIZE, CTD_AUTO_NO, CTD_DEF_ZERO, CTD_MIN_ZERO,
...
HAVE_CONTROL(CT_THRESHOLD, CTD_AUTO_NO, 0, 0, 100, 10, CTD_PERCENTAGE)
HAVE_CONTROL(CT_TRANSPARENCY, CTD_AUTO_NO, 5, MIN_OVERLAY_TRANSPARENCY,
    MAX_OVERLAY_TRANSPARENCY, CTD_STEP_1, CTD_PERCENTAGE)
HAVE_CONTROL(CT_TARGET_TRAILS, CTD_AUTO_NO, CTD_DEF_OFF, CTD_MIN_ZERO, 6,
    CTD_STEP_1, TARGET_TRAIL_NAMES)
HAVE_CONTROL(CT_TRAILS_MOTION, CTD_AUTO_NO, CTD_DEF_ZERO, CTD_MIN_ZERO, 1,
    CTD_STEP_1, TRAIL_MOTION_NAMES)
HAVE_CONTROL(CT_TARGET_ON_PPI, CTD_AUTO_NO, CTD_DEF_ZERO, CTD_MIN_ZERO, 1,
    CTD_STEP_1, TARGET_ON_PPI_NAMES)
HAVE_CONTROL(CT_RANGE_ADJUSTMENT, CTD_AUTO_NO, CTD_DEF_ZERO, -100, CTD_MAX_100,
    CTD_STEP_1, { _("* 0.1 %") })
